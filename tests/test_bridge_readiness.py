...
class Windows(unittest.TestCase):
    ...
    def test_absolute_rule_preserves_a_unicode_path_without_a_space(self):
        self.assertEqual(self.rules_for('C:\\Users\\学生\\GitHub\\my-workbench'), [
            'PowerShell(workforce/skills/aibl-bridge/scripts/windows/bridge-go.ps1)',
            'PowerShell(C:/Users/学生/GitHub/my-workbench/workforce/skills/aibl-bridge/scripts/windows/bridge-go.ps1)',
        ])
